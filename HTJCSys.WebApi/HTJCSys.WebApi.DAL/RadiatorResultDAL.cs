...
namespace DAL
{
    public class RadiatorResultDAL
    {
		...
		public bool Add(MDL.RadiatorResultMDL model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@radiatorcode",  model.radiatorcode),
					new SqlParameter("@condensercode",  model.condensercode),
					new SqlParameter("@fanassemblycode",  model.fanassemblycode),
					new SqlParameter("@intercoolercode",  model.intercoolercode),
					new SqlParameter("@torque1",  model.torque1),
					new SqlParameter("@angle1",  model.angle1),
					new SqlParameter("@torque2",  model.torque2),
					new SqlParameter("@angle2",  model.angle2),
					new SqlParameter("@torque3",  model.torque3),
					new SqlParameter("@angle3",  model.angle3),
					new SqlParameter("@torque4",  model.torque4),
					new SqlParameter("@angle4",  model.angle4),
					new SqlParameter("@torque5",  model.torque5),
					new SqlParameter("@angle5",  model.angle5),
					new SqlParameter("@torque6",  model.torque6),
					new SqlParameter("@angle6",  model.angle6),
