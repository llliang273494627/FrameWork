...
namespace DAL
{
	...
	public partial class ProductInfoDAL
    {
		...
		public bool Add(MDL.ProductInfoMDL model)
		{
            ...
            strSql.Append("ProductType,ProductCode,ProductName,FeatureIndex,FeatureCode,BarCodeCount,HaveSub,[Desc])");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@BarCodeCount",  model.BarCodeCount),
					new SqlParameter("@HaveSub",  model.HaveSub),
        ...
        ///// 得到一个对象实体
        ///// </summary>
        //public MDL.ProductInfoMDL GetModel(string ProductCode)
        //{

        //    StringBuilder strSql = new StringBuilder();
        //    strSql.Append("select TID,ProductType,ProductCode,ProductName,FeatureIndex,FeatureCode,BarCodeCount,[Desc] from ProductInfo ");
		...
		public DataSet GetList(string strWhere)
		{
            ...
            DataSet set =helper.Query(strSql.ToString());
            return set;
		}
