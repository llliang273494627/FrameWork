...
namespace DSGTestNet.Comm
{
    public class CCar
    {
        ...
        string m_TireRFMdl = string.Empty;
        string m_TireRFPre = string.Empty;
        string m_TireRFTemp = string.Empty;
        string m_TireRFBattery = string.Empty;
        string m_TireRFAcSpeed = string.Empty;
        string m_TireRRID = string.Empty;
        string m_TireRRMdl = string.Empty;
        string m_TireRRPre = string.Empty;
        string m_TireRRTemp = string.Empty;
        string m_TireRRBattery = string.Empty;
        string m_TireRRAcSpeed = string.Empty;
        string m_TireLFID = string.Empty;
        string m_TireLFMdl = string.Empty;
        string m_TireLFPre = string.Empty;
        string m_TireLFTemp = string.Empty;
        string m_TireLFBattery = string.Empty;
        string m_TireLFAcSpeed = string.Empty;
        string m_TireLRID = string.Empty;
        string m_TireLRMdl = string.Empty;
        string m_TireLRPre = string.Empty;
        string m_TireLRTemp = string.Empty;
        string m_TireLRBattery = string.Empty;
        string m_TireLRAcSpeed = string.Empty;
