...
namespace DSGTestNet.SqlServers
{
    public class Service_T_RunParam : FrameWork.Model.Comm.HelperSqlsugar
    {
        ...
        public async static Task<int> Updata(string group, string key, string value)
        {
            ...
            {
                HelperLogWrete.Error<Service_T_RunParam>("修改参数失败！", ex);
                return 0;
            }
        }
        ...
        public async static Task<DataTable> GetRunParams(string group)
        {
            ...
            {
                HelperLogWrete.Error<Service_T_RunParam>("获取运行参数失败！", ex);
        ...
        public async static Task<List<string>> GetGroups()
        {
            ...
            {
                HelperLogWrete.Error<Service_T_RunParam>("获取运行参数组失败！", ex);
