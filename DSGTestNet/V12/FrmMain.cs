...
namespace DSGTestNet.V12
{
    public partial class FrmMain : DSGTestSL.FrmMain
    {
        ...
        /// <param name="e"></param>
        private void MSCommBTO_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            try
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void MSComVINO_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            try
            {
                var serial = sender as SerialPort;
