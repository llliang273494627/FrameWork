...
Friend Class FrmMain
    ...
    Private Sub Command8_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command8.Click
        ...
        If TestStateFlag = 0 Then
            ...
            'UPGRADE_WARNING: 未能解析对象 oRVT520.ResetResult 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
            oRVT520.ResetResult()
            ...
            car.TireRFID = tmpID
            'UPGRADE_WARNING: 未能解析对象 oRVT520.Result 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
    ...
    Private Sub Command9_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles Command9.Click
        ...
        If TestStateFlag = 1 Then
            ...
            'UPGRADE_WARNING: 未能解析对象 oLVT520.ResetResult 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
            oLVT520.ResetResult()
            ...
            car.TireLFID = tmpID
            'UPGRADE_WARNING: 未能解析对象 oLVT520.Result 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
...
END_ERR:
    ...
    Public Sub showDSGInfo(ByRef str_Renamed As String, ByRef text_Renamed As String, ByRef model As String, ByRef pressure As String, ByRef temperature As String, ByRef battery As String, ByRef acSpeed As String, ByRef imgName As String)
        ...
        Controls.Item($"txt{str_Renamed}").Text = text_Renamed
        frmInfo.Controls.Item($"txt{str_Renamed}").Text = text_Renamed
        CType(Controls.Item("pic" & str_Renamed), PictureBox).Image = Image.FromFile(My.Application.Info.DirectoryPath & "\img\" & imgName)
        CType(frmInfo.Controls.Item("pic" & str_Renamed), PictureBox).Image = Image.FromFile(My.Application.Info.DirectoryPath & "\img\" & imgName)
        Controls.Item($"lb{str_Renamed}Mdl").Text = model
        frmInfo.Controls.Item($"lb{str_Renamed}Mdl").Text = model
...
Err_Renamed:
    ...
    Private Sub TSStateQuery()
        ...
        'UPGRADE_WARNING: 未能解析对象 oRVT520.ResetResult 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
        oRVT520.ResetResult()
        'UPGRADE_WARNING: 未能解析对象 oRVT520.status 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
        ...
        'UPGRADE_WARNING: 未能解析对象 oLVT520.ResetResult 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
        oLVT520.ResetResult()
        'UPGRADE_WARNING: 未能解析对象 oLVT520.status 的默认属性。 单击以获得更多信息:“ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"”
