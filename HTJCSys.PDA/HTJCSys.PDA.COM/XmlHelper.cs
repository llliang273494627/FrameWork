...
namespace COM
{
    public class XmlHelper
    {
        ...
        public XmlHelper()
        {
            ...
            this.path = BaseVariable.XmlFilePath;
        ...
        public XmlHelper(String Path,string fileName)
        {
            ...
            {
                this.path = BaseVariable.APPRootPath + fileName;
            }
            else
            {
        ...
        public void SaveToXml(string filePath, object sourceObj, Type type, string xmlRootName)
        {
            if (!string.IsNullOrEmpty(filePath) && sourceObj != null)
            {
                ...
                {
                    System.Xml.Serialization.XmlSerializer xmlSerializer = string.IsNullOrEmpty(xmlRootName) ? new System.Xml.Serialization.XmlSerializer(type) : new System.Xml.Serialization.XmlSerializer(type, new XmlRootAttribute(xmlRootName));
